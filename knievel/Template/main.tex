...
\begin{center}
  ...
  \begin{minipage}[t]{\textwidth}
    \includegraphics[width=0.4\textwidth, keepaspectratio]{Figures/htwg.png}\hspace{0.19\textwidth} \includegraphics[width=0.4\textwidth,keepaspectratio]{Figures/AL090142_large.jpg}
  \end{minipage}
...
%	Sperrvermerk PAGE
%----------------------------------------------------------------------------------------
\includepdf[pages=-]{Sperrvermerk.pdf}
...
%	DECLARATION PAGE
%----------------------------------------------------------------------------------------
\includepdf[pages=-]{Eigenstaendigkeitserklaerung_24-08.pdf}
% \begin{declaration}
...
An dieser Stelle möchte ich mich bei allen bedanken, die mich während der Erstellung dieser Bachelorarbeit unterstützt haben.

Mein besonderer Dank gilt zunächst der AUDI AG für die Möglichkeit, meine Abschlussarbeit im Unternehmen durchführen zu dürfen. Ich danke insbesondere meinem Betreuer Tom Wagemann für die fachliche Begleitung, die konstruktiven Rückmeldungen sowie das entgegengebrachte Vertrauen.

Ebenso möchte ich mich bei meinem Hochschulbetreuer Prof. Dr. Knievel von der HTWG Konstanz bedanken. Die wissenschaftliche Betreuung, die hilfreichen Anregungen und die Unterstützung während des gesamten Projekts haben wesentlich zum Gelingen dieser Arbeit beigetragen.

Ein herzlicher Dank gilt auch meinen Kolleginnen und Kollegen bei Audi, die mich freundlich aufgenommen und mir bei Fragen jederzeit weitergeholfen haben.
...
\textbf{FAS} & \textbf{F}ahrer \textbf{A}ssistenz \textbf{S}ystem(e)\\
\textbf{KPI} & \textbf{K}ey \textbf{P}erformance \textbf{I}ndicators\\
\textbf{DGPS} & \textbf{D}ifferential \textbf{G}lobal \textbf{P}ositioning \textbf{S}ystem\\
\textbf{IMU} & \textbf{I}nertial \textbf{M}easurement \textbf{U}nit\\
\textbf{CNN} & \textbf{C}onvolutional \textbf{N}eural \textbf{N}etwork\\
\textbf{KNN} & \textbf{K}ünstliche(s) \textbf{N}eurale(s) \textbf{N}etz(e)\\
...
\include{Chapters/StandDerForschung}
...
%Messaufbau
	% Kamera seitl. -> Reifen+Linie --> keine relative Einmessung
...
% KI-Modell
	% Aufbau
	% Laufzeiten
	% Auswertung: IoU, Dice, F1, Audi-GT+ GPS-GT ...https://www.geeksforgeeks.org/what-are-different-evaluation-metrics-used-to-evaluate-image-segmentation-models/
	% Interpretability
