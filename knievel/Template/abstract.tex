...
Diese soll es ermöglichen Fahrerassistenzsysteme ohne den Zugriff auf interne Bussignale zu bewerten. 
...
Zusätzlich soll diese Zielgrö{\ss}e mit einem Konfidenzwert zur Beaurteilung der Unsicherheit des ausgegebenen Abstandswertes versehen werden.
...
Der zweite Wert berücksichtigt die durch die Polynomapproximation entstehende Unsicherheit des berechneten Abstandswertes auf Radhöhne, indem der durchschnittliche Abstand des erkannten Segments zum sauber kalbrierten Bereich nahe das Rades berechnet wird.

Der letzte Bestandteil des Konfidenzwerts wird anhand einer Historienbetrachtung bestimmt, sodass unplausible Sprünge z.B. zwischen verschiedenen Fahrbahnmarkierungen entprechend niedrig bewertet werden.
...
Im Hauptszenario Autobahnfahrt ohne Sondersituationen wie Baustellen, funktioniert die Abstandsberechnung mit Ausnahme eines kleinen Offsets von etwa 0,05m zur Ground-Truth bereits gut. Dieser Offset kommt dadurch Zustande, dass die dichteste Fahrbahnmarkierung häufig nicht stabil genug erkannt wird, um den Abstand exakt zur Innenkante der Markierung. Stattdessen reicht der Punkt zum dem der Abstand berechnet wird etwas zur Mitte der Markierung, sodass der berechnte Abstand entsprechend etwas zu hoch ist.

Verbesserungspotenial besteht somit besonders in der verbesserten Segmentierung der dichtesten Spurmarkierung, was durch ein Fine-Tuning des Modells mit eigenen Trainingsdaten aus der vom zugrunde liegenden Datensatz BerkeleyDeepDrive abweichenden Kameraperspektive erreicht werden kann.
