...
\label{chapter_datasets}
    ...
    \subsection{CULane}
    Da zuvor erschienene Datensätze zu klein und/oder zu einfach waren, wurde im Rahmen des Papers "Spatial As Deep: Spatial CNN for Traffic Scene Understanding" der neue Datensatz CULane vorgestellt \cite{CULanePaper}.
